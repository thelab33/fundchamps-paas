...
# Stripe API key initialization - best to set in app factory or config
...
def handle_checkout_completed(data: Dict[str, Any]) -> None:
    ...
    Approve the corresponding sponsor and update amount.
...
def handle_payment_succeeded(data: Dict[str, Any]) -> None:
    ...
    Link payment to sponsor and update status.
